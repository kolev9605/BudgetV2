    ...
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<string> GenerateEncodedToken(string userName, ClaimsIdentity identity)
        {
            var claims = new[]
            {
                 ...
                 identity.FindFirst(Constants.JwtClaimIdentifierRol),
                 identity.FindFirst(Constants.JwtClaimIdentifierId)
             };
        ...
        public ClaimsIdentity GenerateClaimsIdentity(string userName, string id)
        {
            ...
            {
                new Claim(Constants.JwtClaimIdentifierId, id),
                new Claim(Constants.JwtClaimIdentifierRol, Constants.JwtClaimsApiAccess)
            });
        }
